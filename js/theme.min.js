...
var docReady = function (e) {
  ...
  getData = function (t, r) {
    try {
      return JSON.parse(t.dataset[camelize(r)]);
    } catch (e) {
      return t.dataset[camelize(r)];
    }
  },
  hexToRgb = function (e) {
    (e = 0 === e.indexOf("#") ? e.substring(1) : e),
      (e = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(
        e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (e, t, r, n) {
          return t + t + r + r + n + n;
        })
      ));
    return e
  ...
  getItemFromStore = function (t, r) {
    var n =
      2 < arguments.length && void 0 !== arguments[2]
        ? arguments[2]
        : localStorage;
    try {
      return JSON.parse(n.getItem(t)) || r;
    } catch (e) {
      return n.getItem(t) || r;
    }
  },
  ...
  navbarDarkenOnScroll = function () {
    var t,
      ...
      c,
      l,
      d = "[data-navbar-darken-on-scroll]",
      u = ".navbar-collapse",
      f = ".navbar-toggler",
      p = "collapsed",
      g = "scroll",
    ...
    m &&
      ...
      (d = utils.getData(m, "navbar-darken-on-scroll")),
      (d = e[(u = Object.keys(e).includes(d) ? d : "dark")]),
      (o = "bg-".concat(u)),
      (a = utils.hexToRgb(d)),
      (i = window.getComputedStyle(m).backgroundImage),
      (s = "background-color 0.35s ease"),
      (c = utils.hexToRgb(e[300])),
      (m.style.paddingTop = "".concat(48, "px")),
      (m.style.backgroundImage = "none"),
      (m.style.borderBottom = "none"),
      (l = "shadow-transition"),
      window.addEventListener(g, function () {
        var e = (r.scrollTop / t) * 2;
        1 <= e && (e = 1),
          (m.style.backgroundColor = "rgba("
            ...
            .concat(a[2], ", ")
            .concat(e, ")")),
          (m.style.borderBottom = "1px solid rgba("
            .concat(c[0], ", ")
            .concat(c[1], ", ")
            .concat(c[2], ", ")
            .concat(e, ")")),
          (m.style.paddingTop = "".concat(48 * (1 - e), "px")),
          (m.style.backgroundImage =
            0 < e || utils.hasClass(n, "show") ? i : "none"),
          0.2 < e || utils.hasClass(n, "show")
            ? m.classList.add(l)
            : m.classList.remove(l);
      }),
      utils.resize(function () {
        var e = utils.getBreakpoint(m);
        window.innerWidth > e
          ? (m.classList.remove(o),
            (m.style.backgroundImage = r.scrollTop ? i : "none"),
            (m.style.transition = "none"))
          : utils.hasClass(m.querySelector(f), p) ||
            (m.style.backgroundImage = i),
          window.innerWidth <= e &&
            (m.style.transition = utils.hasClass(n, "show") ? s : "none");
      }),
      n.addEventListener(y, function () {
        m.classList.add(l),
          (m.style.backgroundImage = i),
          (m.style.transition = s);
      }),
      n.addEventListener(b, function () {
        m.classList.remove(l),
          r.scrollTop || (m.style.backgroundImage = "none");
      }),
  ...
  for (var o = 0, a = r; o < a.length; o++) {
    ...
    if (i instanceof Array)
      e instanceof Array || (e = []),
        (e = [].concat(_toConsumableArray(e), _toConsumableArray(i)));
    else if (i instanceof Object)
      for (var s = 0, c = Object.entries(i); s < c.length; s++) {
        var l = _slicedToArray(c[s], 2),
          d = l[0],
          l = l[1];
        l instanceof Object && d in e && (l = deepMerge(e[d], l)),
          (e = _objectSpread(
            _objectSpread({}, e),
            {},
            _defineProperty({}, d, l)
      ...
      deepMerge(
        {
          ...
          spaceBetween: 30,
          pagination: {
            el: document.getElementById(e.dataset.paginationTarget),
            type: "bullets",
            clickable: !0,
          },
          breakpoints: {
        ...
        e.dataset.option ? JSON.parse(e.dataset.option) : {}
      )
    );
  });
}
