...
function visiable(T) {
  console.log(T);
  var isdisplay = document.querySelector('#'+T+' .description');
  console.log(isdisplay.classList.contains('d-none'));
  
   if (isdisplay.classList.contains('d-none')) {
     document.querySelector('#'+T+' .hide').classList.add('d-block');
     document.querySelector('#'+T+' .hide').classList.remove('d-none');
     document.querySelector('#'+T+' .unhide').classList.add('d-none');
     document.querySelector('#'+T+' .unhide').classList.remove('d-block');
     
     document.querySelector('#'+T+' .description').classList.add('d-block');
     document.querySelector('#'+T+' .description').classList.remove('d-none');
    } else {
    document.querySelector('#'+T+' .hide').classList.add('d-none');
    document.querySelector('#'+T+' .hide').classList.remove('d-block');
    document.querySelector('#'+T+' .unhide').classList.add('d-block');
    document.querySelector('#'+T+' .unhide').classList.remove('d-none');
    
    document.querySelector('#'+T+' .description').classList.add('d-none');
    document.querySelector('#'+T+' .description').classList.remove('d-block');
